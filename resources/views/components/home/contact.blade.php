          ...
          <div class="row g-4">
            <div class="col-12 col-md-6">
              <div class="contact-info">
                ...
                <a class="text-white hover-red mb-2 d-inline-block" href="tel:+78142332211">+7(814)-233-22-11</a>
            ...
            <div class="col-12 col-md-6">
              ...
              <form action="#">
                <input class="form-control form-contact mb-3" type="text" placeholder="Имя">
                <input class="form-control form-contact mb-3" type="email" placeholder="Email">
                <input class="form-control form-contact mb-3" type="tel" placeholder="Телефон">
